...
const SignUp = () => {
  ...
  const [buttonActivate, setButtonActive] = useState(false);
  
  // const activateSubmit = (data) => {
  //   if (data.user_name.trim() !== '' && data.email.trim() !== '' && data.password.trim() !== '' && data.user_password.trim() !== '') {
              ...
              <form name="registerData" onSubmit={RegisterId}>
                ...
                <div className="signup-form-group">
                  ...
                  <div className="signup-email-group">
                    <input type="email" name="user_email" placeholder="info@xyz.com" onChange={emailHandle}/>
                ...
                <div className="signup-form-group signup-email-confirm-group">
                  ...
                  <div className="signup-email-group">
                    ...
                    <button className="signup-verify-btn">인증코드 발송</button>
                    <button className="signup-verify-btn">인증확인</button>
                  </div>
                </div>
                <div className="signup-form-group">
                ...
                <button type="submit" className="signup-signup-btn" disabled={buttonActivate}>SIGN UP</button>
              </form>
            </div>
          </div>
        </div>
